...
DUALSENSE_VENDOR_ID = 1356
DUALSENSE_PRODUCT_ID = 2508

# DualShock settings. Used by DualSense class in robosuite/devices/dualsense.py
DUALSHOCK_VENDOR_ID = 1356
DUALSHOCK_PRODUCT_ID = 2508
